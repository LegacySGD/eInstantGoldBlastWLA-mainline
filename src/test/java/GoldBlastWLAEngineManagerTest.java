...
public class GoldBlastWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(GoldBlastWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/GoldBlastWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/GoldBlastWLAIW/InitOutcome.xml").getDocumentElement();
